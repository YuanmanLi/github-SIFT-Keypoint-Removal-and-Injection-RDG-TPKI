...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [c , ceq]  =  con_fun(x, I_col,I,  G_cell, R,win,  s, win_var,var_indx_r, var_indx_c, max_min_loc, par)

    y = reshape(x, win_var);
    I(var_indx_r, var_indx_c) = y;
   G1_I = imfilter(I,G_cell{1},'replicate');                                 % the size of I should be the same with original image
